...
if (!$authController->isLoggedIn() || !$authController->checkRole('admin')) {
    header('Location: /login.php?redirect=admin/add_product');
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $image = 'default.jpg'; // За замовчуванням
    ...
    if (empty($name) || $category_id <= 0 || $price <= 0) {
        ...
        // Якщо немає помилок, додаємо товар
        if (empty($message)) {
            $productData = [
                'name' => $name,
            ...
            // Використовуємо контролер начальника складу для додавання товару
            require_once ROOT_PATH . '/controllers/WarehouseController.php';
            $warehouseController = new WarehouseController();
            $result = $warehouseController->addProduct($productData);
            ...
            if ($result['success']) {
                ...
                $message = 'Помилка при додаванні товару: ' . $result['message'];
                $messageType = 'error';
            }
        }
    }
...
<head>
    ...
    <title>Додавання нового товару - Винна крамниця</title>
        ...
        <div class="flex-1">
            ...
            <header class="bg-white shadow">
                <div class="flex items-center justify-between px-6 py-4">
                    <h1 class="text-2xl font-semibold text-gray-800">Додавання нового товару</h1>
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-2 gap-4 mb-4">
                                    <div>
                                        ...
                                        <input type="number" id="min_stock" name="min_stock" min="0" value="10"
                                               class="border rounded w-full px-3 py-2 focus:outline-none focus:ring-2 focus:ring-red-500">
                                    </div>
                                    <div>
                                ...
                                <div class="grid grid-cols-2 gap-4 mb-4">
                                    ...
                                    <div>
                                        ...
                                        <input type="number" id="volume" name="volume" min="0" value="750"
                                               class="border rounded w-full px-3 py-2 focus:outline-none focus:ring-2 focus:ring-red-500">
                                    </div>
                                </div>
                                ...
                                <div class="mb-4">
                                    <div class="flex items-center">
                                        <input type="checkbox" id="featured" name="featured" class="h-4 w-4 text-red-600 focus:ring-red-500 border-gray-300 rounded">
